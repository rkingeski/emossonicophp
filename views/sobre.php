...
<div class="container mt-4">
	<div class="row jusfify-content-between">
		...
		<div class="col-md-6">
			<div
				...
				<div class="col p-4">
					...
					<p class="mb-auto">Rafael Kingeski - Mestre em Engenharia Elétrica pela Universidade do
						Estado de Santa Catarina (UDESC). Atualmente Doutorando pela UDESC.
					</p>
				</div>
	...
	<span>Site desenvolvido por: <a href="mailto:rkingeski@hotmail.com">Rafael Kingeski</a></span>
</div>
</body>
