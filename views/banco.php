    ...
    <tbody>
        <?php foreach($registros as $registro): ?>
			...
			<tr>
				...
				<button id="concordo" class='btn btn-primary'><span class=''><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
			  	...
			  	</svg></span>Concordo <?= $registro['sam1'] . "0%" ?></button>	
				
				<button id="discordo" class='btn btn-secondary'><span class=''><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
